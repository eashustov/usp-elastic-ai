...
import ru.sberbank.uspelasticai.ai.tools.LabelSeeker;
import ru.sberbank.uspelasticai.ai.tools.MeansBuilder;
...
public class ParagraphVectorsClassifierExample {
    ...
    private static final Logger log = LoggerFactory.getLogger(ru.sberbank.uspelasticai.ai.ParagraphVectorsClassifierExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ru.sberbank.uspelasticai.ai.ParagraphVectorsClassifierExample app = new ru.sberbank.uspelasticai.ai.ParagraphVectorsClassifierExample();
