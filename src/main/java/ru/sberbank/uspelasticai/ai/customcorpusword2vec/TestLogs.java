...
import ru.sberbank.uspelasticai.elastic.services.LogBlockingQueue;
import ru.sberbank.uspelasticai.elastic.services.SearchAndGetElasticData;
...
import static ru.sberbank.uspelasticai.elastic.services.SearchAndGetElasticData.logBlockingQueue;
 ...
 */
@Component
public class TestLogs extends JFrame {
    ...
    private TestLogs() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        this.setTitle("Predict Logs Category");
...
//            System.out.println("Сообщение из очереди" + SearchAndGetElasticData.logsQueue.take().toString());
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            Logger.getLogger(TestLogs.class.getName()).log(Level.SEVERE, null, ex);
        }
        TestLogs test = new TestLogs();
    ...
    private static DataSet prepareTestData(String i_news) {
        ...
        INDArray labels = Nd4j.create(news.size(), 5, maxLength);    //labels: Crime, Politics, Bollywood, Business&Development, Logs
