...
package ru.sberbank.uspelasticai.ai.customcorpusword2vec;
...
public class TrainLogs {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LogsIterator iTrain = new LogsIterator.Builder()
        ...
        LogsIterator iTest = new LogsIterator.Builder()
            .dataDirectory(DATA_PATH)
            .wordVectors(wordVectors)
            .batchSize(batchSize)
            .tokenizerFactory(tokenizerFactory)
